...
switch lower(FEATURE)    
    case 'tiny image'
        ...
        train_image_feats = get_tiny_images(train_image_paths, 7, 1, 1, 1);
        test_image_feats  = get_tiny_images(test_image_paths, 7, 1, 1, 1);
    case 'colour histogram'
        %You should allow get_colour_histograms to take parameters e.g.
        %quantisation, colour space etc.
        train_image_feats = get_colour_histograms(train_image_paths, 11, 1, 2, 1);
        test_image_feats  = get_colour_histograms(test_image_paths, 11, 1, 2, 1);
end
